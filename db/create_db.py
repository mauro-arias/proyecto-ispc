...
from db.entities import Persona, Barrio, Campus, Carrera, Ciudad, Facultad, Genero, Lugar, Pais, Provincia, TipoPersona, Titulacion, Universidad, PersonaTitulacion, Estado
